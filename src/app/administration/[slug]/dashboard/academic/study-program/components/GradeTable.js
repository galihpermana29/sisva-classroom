    ...
    >
      <IconButton
        ...
        onClick={(e) => {
          ...
          params.value.formik.setFieldValue('name', params.value.data.name);
...
export default function GradeTable({ data, formik, tableData }) {
  ...
  data.map((grade) => {
    let tempObject = {
      ...
      code: grade.code,
      grade: grade.grade,
      studyProgramId: grade.studyProgramId,
      action: {
        data: grade,
        grade: grade.grade,
