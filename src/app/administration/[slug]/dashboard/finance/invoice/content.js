...
export default function StaffProfileListContent() {
  ...
  let data = [
    ...
    {
      id: "INV 2023/XI/002",
      name: "Iuran Kerja Bakti",
      target: "Staf",
      dueDate: "4/11/2023 23:30",
      status: "Selesai",
      nominal: "Rp80.000",
      payments: "50/50",
    },
    ...
    return (
      ...
      >
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <DatePicker
            sx={{ width: "180px", minWidth: 180, flex: { xs: 1, lg: 0 } }}
        ...
        >
          {["Murid", "Guru", "Staf"].map((option, index) => (
        ...
        >
          {["Selesai", "Belum Selesai"].map((option, index) => (
            <MenuItem key={index} value={option}>
              <Typography fontSize={14}>{option}</Typography>
            </MenuItem>
          ))}
  ...
  return (
    <Stack sx={{ height: "100%", width: "100%", p: { xs: 0, lg: 4 } }}>
      ...
      >
        <Typography sx={{ fontSize: 20, fontWeight: 600 }}>Invoice</Typography>
      </Stack>
      <Stack
        component={Paper}
        variant="outlined"
