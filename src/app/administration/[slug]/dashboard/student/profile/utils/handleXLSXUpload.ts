      ...
      const dataObject = rawDataWithoutHeader
        .map((row) => {
          ...
          return {
            ...
            guardian_type: row[12],
            //
            father_name: row[13],
            father_email: row[14],
            father_phone: row[15],
            father_occupation: row[16],
            father_education: row[17],
            father_income: row[18],
            father_birth_year: row[19],
            father_life_status: row[20],
            father_religion: row[21],
            ...
            mother_education: row[27],
            mother_income: row[28],
            mother_birth_year: row[29],
            mother_life_status: row[30],
            mother_religion: row[31],
            mother_address: row[32],
            //
            guardian_name: row[33],
            guardian_gender: row[34],
            guardian_relationship: row[35],
            guardian_email: row[36],
            guardian_phone: row[37],
            guardian_occupation: row[38],
            guardian_education: row[39],
            guardian_income: row[40],
            guardian_birth_year: row[41],
            guardian_life_status: row[42],
            guardian_religion: row[43],
