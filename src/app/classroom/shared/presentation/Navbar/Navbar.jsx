...
const SisvaNavbar = () => {
  ...
  return (
    <>
      <nav className="bg-white px-5 py-4 hidden sm:block sticky top-0 border-b border-b-[#F5F5F5] shadow-md">
      ...
      <nav
        className="sm:hidden fixed bottom-0 left-0 right-0 bg-white shadow-top rounded-l-[20px] rounded-r-[20px]"
        style={{
